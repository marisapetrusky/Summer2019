...
{	
	...
	// 1D Histograms
	TH1D * h_ph_proj = h_ladc0_ph->ProjectionX("#phi",0,-1);
	TH1D * h_th_proj = h_ladc0_th->ProjectionX("#theta",0,-1);
	TH1D * h_ladc0_proj = h_ladc0_ph->ProjectionY("Low ADC0 Charge",0,-1);
	TH1D * h_hadc0_proj = h_hadc0_ph->ProjectionY("High ADC0 Charge",0,-1);
	TH1D * h_ladc1_proj = h_ladc1_ph->ProjectionY("Low ADC1 Charge",0,-1);
	TH1D * h_hadc1_proj = h_hadc1_ph->ProjectionY("High ADC1 Charge",0,-1);
