...
void GetRange(TH1 * h, double overflow, double& xmin, double& xmax);
...
void ADC_langaufit()
{
	...
	// Histograms
	TH1D * h_hadc0 = new TH1D("hadc0","Quartz 1, High Resolution",17,0.,0.);//22,0.,0.);
	...
	GetRange(h_ladc0,overflow,xmin_ladc0,xmax_ladc0);
	GetRange(h_ladc1,overflow,xmin_ladc1,xmax_ladc1);
	GetRange(h_hadc0,overflow,xmin_hadc0,xmax_hadc0);
	GetRange(h_hadc1,overflow,xmin_hadc1,xmax_hadc1);
